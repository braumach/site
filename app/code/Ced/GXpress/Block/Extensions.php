...
namespace Ced\GXpress\Block;
/**
 * Class Extensions
 * @package Ced\GXpress\Block
 */
class Extensions extends \Magento\Config\Block\System\Config\Form\Fieldset
{
    ...
    )
    {
        ...
        $this->_helper = $this->_objectManager->get('Ced\GXpress\Helper\Data');
    ...
    public function render(\Magento\Framework\Data\Form\Element\AbstractElement $element)
    {
        ...
        $modules = $this->_objectManager->get('\Ced\GXpress\Helper\Feed')->getAllModules();
    ...
    {
        $hash = \Ced\GXpress\Block\Extensions::HASH_PATH_PREFIX . strtolower($moduleName) . '_hash';
        $level = \Ced\GXpress\Block\Extensions::HASH_PATH_PREFIX . strtolower($moduleName) . '_level';

        $helper = $this->_objectManager->create('\Ced\GXpress\Helper\Data');
        ...
        $l = $this->_objectManager->create('\Ced\GXpress\Helper\Feed')->getLicenseFromHash($hash, $level);
