...
namespace Ced\TradeMe\Ui\DataProvider\Product;

use Magento\Catalog\Model\ResourceModel\Product\CollectionFactory;
use Magento\Framework\Api\FilterBuilder;

/**
 * Class TradeMeProduct
 * @package Ced\TradeMe\Ui\DataProvider\Product
 */
class TradeMeProduct extends \Magento\Ui\DataProvider\AbstractDataProvider
{
    /**
     * @var
     */
    ...
    public function __construct(
        ...
        try {
            ...
            $pids = $this->objectManager->create('Ced\TradeMe\Model\Profile')->getCollection()->addFieldToFilter('profile_status', 1)->getColumnValues('id');
            ...
            //$this->collection->joinAttribute('trademe_listing_id', "catalog_product/$itemIdAccAttr", 'entity_id', null, 'left');
            $this->collection->joinAttribute('trademe_listing_error', "catalog_product/$listingErrorAccAttr", 'entity_id', null, 'left');
            $this->collection->joinAttribute('trademe_product_status', "catalog_product/$prodStatusAccAttr", 'entity_id', null, 'left');
            $this->collection->joinAttribute('trademe_profile_id', "catalog_product/$this->profileIdAccAttr", 'entity_id', null, 'left');
            $this->collection->joinAttribute('trademe_listing_id', "catalog_product/$prodListingAccAttr", 'entity_id', null, 'left');
