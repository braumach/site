...
class Extensions extends \Magento\Config\Block\System\Config\Form\Fieldset
{
    ...
    public function __construct(
        ...
        $this->_helper = $this->_objectManager->get('Ced\FbNative\Helper\Data');
    ...
    public function render(\Magento\Framework\Data\Form\Element\AbstractElement $element)
    {
        ...
        $modules =  $this->_objectManager->get('\Ced\FbNative\Helper\Feed')->getAllModules();
    ...
    {
        $hash = \Ced\FbNative\Block\Extensions::HASH_PATH_PREFIX.strtolower($moduleName).'_hash';
        $level = \Ced\FbNative\Block\Extensions::HASH_PATH_PREFIX.strtolower($moduleName).'_level';

        $helper = $this->_objectManager->create('\Ced\FbNative\Helper\Data');
        ...
        $l = $this->_objectManager->create('\Ced\FbNative\Helper\Feed')->getLicenseFromHash($hash,$level);
