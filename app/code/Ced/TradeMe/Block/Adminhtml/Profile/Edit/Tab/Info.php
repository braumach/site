...
class Info extends \Magento\Backend\Block\Widget\Form\Generic
{
    ...
    protected function _prepareForm()
    {
        ...
        //$businessPolicyProfile = json_decode($profile->getData('business_policy_profile'), true);
        ...
        $fieldset->addField('profile_status', 'select',
            array(
                ...
                'values' => $this->_objectManager->get('Ced\TradeMe\Model\Source\Profile\Status')->getOptionArray(),
            )
        );
