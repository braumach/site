...
use Ced\TradeMe\Model\ResourceModel\Accounts\CollectionFactory;
    ...
    public function execute()
    {
        ...
        if (!empty($ids)) {
            ...
            if (isset($collection) and $collection->getSize() > 0) {
                ...
                $this->multiAccountHelper->deleteAccountAssociates($accountIds);
        ...
        return $this->_redirect('trademe/account/index');
    }
}
