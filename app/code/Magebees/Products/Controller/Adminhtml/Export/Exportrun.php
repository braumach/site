...
class Exportrun extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        $export_file_name = $this->_objectManager->create('\Magebees\Products\Model\Exportproduct')->getProductExportFile($page, $store_export_id, $attr_id, $export_for, $timestamp, $type_id, $status_id, $visibility_id, $cat_ids, $fromId, $toId);
