...
class Delete extends \Magento\Customer\Controller\Adminhtml\Group
{
	...
	public function execute()
    {
        ...
        if ($code) {
            $model = $this->_objectManager->create('Ced\GXpress\Model\Profile')->getCollection()->addFieldToFilter('profile_code', $code);
            // entity type check
            try {
              ...
              $this->_objectManager->create('Ced\GXpress\Helper\Logger')->addError('In Delete Profile: '.$e->getMessage(), ['path' => __METHOD__]);
