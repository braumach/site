...
class Grid extends AbstractDataProvider
{
    ...
    public function __construct(
        ...
        \Ced\Amazon\Model\ResourceModel\Profile\Product\CollectionFactory $product,
    ...
    public function getData()
    {
        ...
        foreach ($items as &$item) {
            ...
            $item['total_products'] = (string)$this->product->create()
                ->addFieldToFilter(
                    \Ced\Amazon\Model\Profile\Product::COLUMN_PROFILE_ID,
                    ['eq' => $item[\Ced\Amazon\Model\Profile::COLUMN_ID]]
                )
                ->getSize();
        }
