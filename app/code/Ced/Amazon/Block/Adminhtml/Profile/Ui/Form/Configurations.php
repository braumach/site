 ...
 * @package Ced\Amazon\Block\Adminhtml\Profile\Ui\Form
 */
class Configurations extends \Magento\Config\Block\System\Config\Form
{
    ...
    public function isVisible()
    {
        ...
        $showInScope = [
            ...
            \Magento\Store\Model\ScopeInterface::SCOPE_VENDOR => $this->_hasVisibilityValue('showInGlobal'),
    ...
    )
    {
        ...
        $formField = $fieldset->addField(
            ...
            [
                ...
                'data-form-part' => "lazada_profile_edit", // added for for form save to send values
            ]
        );
