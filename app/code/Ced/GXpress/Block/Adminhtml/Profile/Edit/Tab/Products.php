...
namespace Ced\GXpress\Block\Adminhtml\Profile\Edit\Tab;

/**
 * Class Products
 * @package Ced\GXpress\Block\Adminhtml\Profile\Edit\Tab
 */
class Products extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    )
    {
        ...
        $this->_massactionBlockName = 'Ced\GXpress\Block\Adminhtml\Profile\Widget\Grid\Massaction\Extended';
    ...
    {
        $profileAccount = $this->_coreRegistry->registry('gxpress_account');
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            ...
            array(
                ...
                'sortable' => false,
                'type' => 'options',
                'options' => $this->_objectManager->create('Ced\GXpress\Model\Source\Category')->getAllOptions(),
                'renderer' => 'Ced\GXpress\Block\Adminhtml\Profile\Renderer\Category',
    ...
    public function getProducts($json = false)
    {
        ...
        $currentAccount = $this->_coreRegistry->registry('gxpress_account');
        $ids = $this->_objectManager->create('Ced\GXpress\Model\Profile')->getCollection()->addFieldToFilter('profile_code', $profileCode)->getColumnValues('id');
        if (!empty($ids)) {
