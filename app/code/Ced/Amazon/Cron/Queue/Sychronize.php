...
class Sychronize
{
     ...
     */
    public $amazonProductResource;

    /**
     * @var \Ced\Amazon\Repository\Product
     */
    public $amazonProductRepository;
    ...
    public function __construct(
        ...
        \Ced\Amazon\Model\ResourceModel\Product $amazonProductResource,
        \Ced\Amazon\Repository\Product $amazonProductRepository,
     ...
     */
    public function update($item, array $specifics = [])
    {
        try {
                            ...
                            if (!empty($data)) {
                                ...
                                if (is_array($specifics) && isset($specifics['store_id'])) {
                                    foreach ($data as $sku => $values) {
                                        ...
                                        $profileId = $specifics['profile_id'];
                                        $relationId = $this->amazonProductRepository->getRelationId($productId, $profileId);
                                        $id = $this->amazonProductRepository->getByRelationId($relationId)->getId();
                                        ...
                                        $amazonProductInterface->setFeedErrors(json_encode($values));
                                        $this->amazonProductRepository->save($amazonProductInterface);
...
//                                                json_encode($values)
//                                            );
//                                            $this->amazonProductResource->saveAttribute(
//                                                $p,
//                                                \Ced\Amazon\Helper\Product::ATTRIBUTE_CODE_FEED_ERRORS
//                                            );
//                                        }
