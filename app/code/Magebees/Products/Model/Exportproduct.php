...
class Exportproduct extends \Magento\Framework\Model\AbstractModel
{
	...
	public function getProductExportFile($page,$store_export_id,$attr_id,$export_for,$timestamp,$type_id,$status_id,$visibility_id,$cat_ids,$fromId,$toId){
		$last_page = $this->unparse($page,$store_export_id,$attr_id,$export_for,$type_id,$status_id,$visibility_id,$cat_ids,$fromId,$toId);
		if($last_page==$page){
	...
	public function unparse($page=1,$store_export_id,$attr_id,$export_for,$type_id,$status_id,$visibility_id,$cat_ids,$fromId,$toId)
    {
		if($attr_id != '*'){
