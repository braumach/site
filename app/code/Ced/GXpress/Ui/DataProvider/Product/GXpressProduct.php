...
namespace Ced\GXpress\Ui\DataProvider\Product;
 ...
 * @package Ced\GXpress\Ui\DataProvider\Product
 */
class GXpressProduct extends \Magento\Ui\DataProvider\AbstractDataProvider
{
    ...
    public function __construct(
        ...
        try {
            ...
            $pids = $this->objectManager->create('Ced\GXpress\Model\Profile')->getCollection()->addFieldToFilter('profile_status', 1)->getColumnValues('id');
            ...
            $this->collection->joinAttribute('gxpress_item_id', "catalog_product/$itemIdAccAttr", 'entity_id', null, 'left');
            $this->collection->joinAttribute('gxpress_listing_error', "catalog_product/$listingErrorAccAttr", 'entity_id', null, 'left');
            $this->collection->joinAttribute('gxpress_product_status', "catalog_product/$prodStatusAccAttr", 'entity_id', null, 'left');
            $this->collection->joinAttribute('gxpress_profile_id', "catalog_product/$profileIdAccAttr", 'entity_id', null, 'left');
