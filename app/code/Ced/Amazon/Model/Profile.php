...
class Profile extends \Magento\Framework\Model\AbstractModel implements \Ced\Amazon\Api\Data\ProfileInterface
{
    ...
    {
        $magentoCategory = $this->getData(\Ced\Amazon\Model\Profile::COLUMN_MAGENTO_CATEGORY);
    ...
    {
        return $this->getData(self::COLUMN_BARCODE_EXEMPTION);
    }
    ...
    {
        return $this->setData(self::COLUMN_BARCODE_EXEMPTION, $value);
    }

    public function getStrategyAttribute()
    {
        return $this->getData(self::COLUMN_STRATEGY_ATTRIBUTE);
    }
