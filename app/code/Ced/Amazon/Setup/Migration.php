...
class Migration
{
    ...
    public function __construct(
        ...
        \Ced\Amazon\Model\ResourceModel\Profile\CollectionFactory $profileCollectionFactory,
        \Ced\Amazon\Model\ResourceModel\Profile\Product $productResource,
        \Ced\Amazon\Model\Profile\Attribute\Product $productAttribute,
    ...
    public function updateProfiles()
    {
        ...
        foreach ($profileCollection as $profile) {
            try {
                $productIds = $this->productAttribute->getIds($profile->getId(), $profile->getStoreId());
                $this->resource->addProductsIdsWithProfileId($productIds, $profile->getId());
            } catch (\Exception $e) {
            }
        }
    }
