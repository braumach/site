...
class Actions extends Column
{
    ...
    const URL_PATH_SYNC = 'amazon/queue/sync';
            ...
            foreach ($dataSource['data']['items'] as &$item) {
                ...
                if (isset($item['id'])) {
                    ...
                    $item[$name]['sync'] = [
                        ...
                        'label' => __('Sync'),
                        'confirm' => [
                            'title' => __('Sync Queue Record') . ' #' . $item['id'],
                            'message' => __('Syncing queue is not recommended when ids are greater than 10, it may lead to system timeout.
                             Are you sure you want to sync the queue record?')
                        ],
