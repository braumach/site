 ...
 * @package Ced\GXpress\Block\Adminhtml\Config\Field
 */
class CarrierMappingList extends \Magento\Framework\View\Element\Html\Select
{
    ...
    /**
     * @var \Ced\GXpress\Model\Config\ShippingCarrier
     */
    private $_shipMethod;
     ...
     * @param \Ced\GXpress\Model\Config\ShippingCarrier $shipMethod
     * @param array $data
     */
    public function __construct(
        \Magento\Framework\View\Element\Context $context,
        \Ced\GXpress\Model\Config\ShippingCarrier $shipMethod,
        array $data = []
    )
    {
