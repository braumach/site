...
class Products extends \Magento\Backend\Block\Widget\Grid\Extended
{
     ...
     * @var string
     */
    protected $_template = 'Ced_TradeMe::widget/grid/extended.phtml';
    ...
    )
    {
        ...
        $this->_massactionBlockName = 'Ced\TradeMe\Block\Adminhtml\Profile\Widget\Grid\Massaction\Extended';
    ...
    {
        $profileAccount = $this->_coreRegistry->registry('trademe_account');
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            ...
            array(
                ...
                'sortable' => false,
                'type' => 'options',
                'options' => $this->_objectManager->create('Ced\TradeMe\Model\Source\Category')->getAllOptions(),
                'renderer' => 'Ced\TradeMe\Block\Adminhtml\Profile\Renderer\Category',
    ...
    public function getProducts($json = false)
    {
        ...
        $currentAccount = $this->_coreRegistry->registry('trademe_account');
        $ids = $this->_objectManager->create('Ced\TradeMe\Model\Profile')->getCollection()->addFieldToFilter('profile_code', $profileCode)->getColumnValues('id');
        if (!empty($ids)) {
    ...
    protected function _prepareMassaction()
    {
        ...
        $this->getMassactionBlock()->addItem(
            'addproduct', array(
                ...
                'url' => $this->getUrl('trademe/profile/save'),
            )
        );
        return $this;
    }
