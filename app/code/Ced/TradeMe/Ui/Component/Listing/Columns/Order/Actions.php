...
namespace Ced\TradeMe\Ui\Component\Listing\Columns\Order;
...
/**
 * Class Actions
 * @package Ced\TradeMe\Ui\Component\Listing\Columns\Order
 */
class Actions extends Column
{
    const URL_PATH_EDIT = 'sales/order/view';
    const URL_PATH_VIEW = 'trademe/order/view';
    const URL_PATH_DELETE = 'trademe/order/delete';
            ...
            foreach ($dataSource['data']['items'] as &$item) {
                ...
                if (isset($item['id'])) {
                    ...
                    $item[$name]['view'] = [
                        ...
                        'popup' => [
                            'title' => __("Trade Me Order #{$item['magento_order_id']}"),
                            'message' => $response,
                            'type' => 'json',
                            'render' => 'html',
                        ],
