        ...
        toggleOptionSelected: function (data) {
            ...
            if (!isSelected) {
                ...
                if (!this.empty(categoryPath)) {
                    ...
                    var marketplaceIds = marketplace.value();
                    marketplaceIds = typeof marketplaceIds !== 'object' ? [marketplaceIds] : marketplaceIds;
                    this.updateAttributes(account.value, categoryIds[0], categoryIds[1], marketplaceIds, barcode.value());
                }
            } else {
