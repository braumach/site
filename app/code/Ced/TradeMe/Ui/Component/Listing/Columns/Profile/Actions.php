...
namespace Ced\TradeMe\Ui\Component\Listing\Columns\Profile;
...
{
    const URL_PATH_EDIT = 'trademe/profile/edit';
    const URL_PATH_DELETE = 'trademe/profile/delete';
    const URL_PATH_SYNC = 'trademe/profile/sync';
